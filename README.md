...
* For **MiniMax H3**, load the `taeh3` weights (currently supported in [ComfyUI-KJNodes](https://github.com/kijai/ComfyUI-KJNodes) and [ComfyUI-bleh](https://github.com/blepping/ComfyUI-bleh))
